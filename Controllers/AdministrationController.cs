    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            else
            {
                ...
                // we do not to use the general Exception
                // we only want these error details to be displayed while getting `DbUpdateException` (failed to delete role)
                // for general Exception, we let Error action method handles it.
        ...
        public async Task<IActionResult> ManageUserClaims(UserClaimsViewModel model)
        {
            ...
            // remove all claims from the user first
